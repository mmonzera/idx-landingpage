...
const Benefitcard = () => {
  return (
    <div className="overflow-hidden items-center px-[16px] md:px-[160px] py-[36px] relative bg-white">
      <div className="flex flex-col p-[32px] justify-center items-start gap-[24px] border-[2px] border-[#1EA2EC] rounded-[16px] bg-[#ffffff] shadow-[0px_4px_12px_0px_#E1F1FD] z-10 relative">
        <div className="px-[16px] py-[8px] flex gap-[12px] border-[2px] border-[#1EA2EC] rounded-[12px] z-10">
          <Image src={arrowUp} alt="arrowup" />
          <h3 className="font-semibold text-[16px] text-[#1EA2EC]">
